...
Функция ПечатьДокумента(МассивОбъектов, ОбъектыПечати, ПараметрыПечати)
	...
	|	СменноеЗадание.Количество,
	|	СменноеЗадание.ВремяВыполнения,
	|	СменноеЗадание.ВидСтадииОбработки,
	|	СменноеЗадание.Спецификация,
	|	СменноеЗадание.ПроизводственныйРесурс КАК ПроизводственныйРесурс
	|ИЗ
	|	Документ.mega_СменноеЗадание.Состав КАК СменноеЗадание
	|
	|УПОРЯДОЧИТЬ ПО
	|	Ссылка,
