...
Функция ПечатьДокумента(МассивОбъектов, ОбъектыПечати, ПараметрыПечати)
	...
	ТабличныйДокумент.КлючПараметровПечати	= "ПАРАМЕТРЫ_ПЕЧАТИ_СменноеЗадание_ПечатнаяФорма";
	...
	|	СменноеЗадание.Ссылка.Дата,
	|	СменноеЗадание.Ссылка.Номер,
	|	СменноеЗадание.Ссылка.Автор,
	|	СменноеЗадание.Ссылка.Ответственный,
	|	СменноеЗадание.ТехнологическаяОперация,
	|	СменноеЗадание.ТехнологическаяОперацияЕдиницаИзмерения КАК ЕдиницаИзмерения,
	|	СменноеЗадание.ТехнологическаяОперацияКоличество КАК Количество,
	...
	|	СменноеЗадание.ТехнологическаяОперация.ПроизводственныйРесурс КАК ПроизводственныйРесурс
	|ИЗ
	...
	Пока Шапка.СледующийПоЗначениюПоля("Ссылка") Цикл
		...
		Пока ПроизводственныйРесурс.Следующий() Цикл
			
			Макет = УправлениеПечатью.МакетПечатнойФормы("Документ.mega_СменноеЗадание.ПФ_MXL_ПечатнаяФорма");
			...
			ОбластьМакета.Параметры.ПроизводственныйРесурс = ПроизводственныйРесурс.ПроизводственныйРесурс;		
			...
			Состав = ПроизводственныйРесурс.Выбрать();
