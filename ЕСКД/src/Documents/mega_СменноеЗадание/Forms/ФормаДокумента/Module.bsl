...
Процедура ПриИзмененииНоменклатурыНаСервере(Структура)
	...
	Если ЗначениеЗаполнено(Структура.Номенклатура) Тогда
		...
		ЗначенияРеквизитовОбъекта = 
			ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Структура.Номенклатура, "ЕдиницаИзмерения,Спецификация");
		Структура.ЕдиницаИзмерения = ЗначенияРеквизитовОбъекта.ЕдиницаИзмерения;
		Структура.Спецификация = ЗначенияРеквизитовОбъекта.Спецификация;		
	КонецЕсли;	
КонецПроцедуры
