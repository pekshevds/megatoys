...
Процедура ОбработкаВыбора(ВыбранноеЗначение, ИсточникВыбора)
	...
	Если ИсточникВыбора.ИмяФормы = "Документ.mega_ЗавкаВнутренняя.Форма.ФормаВыбораСпецификации" Тогда
...
Процедура ДобавитьМатериалыСпецификации(Команда)
	...
	ОткрытьФорму("Документ.mega_ЗавкаВнутренняя.Форма.ФормаВыбораСпецификации", 
